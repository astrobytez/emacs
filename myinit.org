...
TODO add conditional that checks if in windowed emacs prior to turning on fonts and sizes.
...
#+BEGIN_SRC emacs-lisp
  ...
  ;                            `(org-document-title ((t (,@headline ,@variable-tuple :height 1.5 :underlin;e nil))))))
#+END_SRC
** Configure org mode
